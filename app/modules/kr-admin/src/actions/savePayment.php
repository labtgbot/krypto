...
try {
    ...
    $App->_savePayment([
      ...
      "stripe_privatekey" => ($_POST['kr-adm-stripekey'] != '*********************' ? App::_encryptSecret($_POST['kr-adm-stripekey']) : $_POST['kr-adm-stripekey']),

      // Save paypal encrypted client id
      "paypal_clientid" => ($_POST['kr-adm-paypalclientid'] != '*********************' ? App::_encryptSecret($_POST['kr-adm-paypalclientid']) : $_POST['kr-adm-paypalclientid']),

      // Save paypal encrypted secret
      "paypal_secret" => ($_POST['kr-adm-paypalclientsecret'] != '*********************' ? App::_encryptSecret($_POST['kr-adm-paypalclientsecret']) : $_POST['kr-adm-paypalclientsecret']),
      ...
      "fortumo_service" => ($_POST['kr-adm-fortumoservicekey'] != '*********************' ? App::_encryptSecret($_POST['kr-adm-fortumoservicekey']) : $_POST['kr-adm-fortumoservicekey']),
      "fortumo_secret" => ($_POST['kr-adm-fortumosecretkey'] != '*********************' ? App::_encryptSecret($_POST['kr-adm-fortumosecretkey']) : $_POST['kr-adm-fortumosecretkey']),
      ...
      "coingate_authtoken" => ($_POST['kr-adm-coingateauthtoken'] != '*********************' ? App::_encryptSecret($_POST['kr-adm-coingateauthtoken']) : $_POST['kr-adm-coingateauthtoken']),
      ...
      "mollie_key" => ($_POST['kr-adm-molliekey'] != '*********************' ? App::_encryptSecret($_POST['kr-adm-molliekey']) : $_POST['kr-adm-molliekey']),
      ...
      "raveflutterwave_public_key" => ($_POST['kr-adm-raveflutterwavepublickey'] != '*********************' ? App::_encryptSecret($_POST['kr-adm-raveflutterwavepublickey']) : $_POST['kr-adm-raveflutterwavepublickey']),
      "raveflutterwave_secret_key" => ($_POST['kr-adm-raveflutterwavesecretkey'] != '*********************' ? App::_encryptSecret($_POST['kr-adm-raveflutterwavesecretkey']) : $_POST['kr-adm-raveflutterwavesecretkey']),
      ...
      "coinpayments_publickey" => ($_POST['kr-adm-coinpaymentspublickey'] != '*********************' ? App::_encryptSecret($_POST['kr-adm-coinpaymentspublickey']) : $_POST['kr-adm-coinpaymentspublickey']),
      "coinpayments_privatekey" => ($_POST['kr-adm-coinpaymentsprivatekey'] != '*********************' ? App::_encryptSecret($_POST['kr-adm-coinpaymentsprivatekey']) : $_POST['kr-adm-coinpaymentsprivatekey']),
      "coinpayments_marchant_id" => ($_POST['kr-adm-coinpaymentsmarchandid'] != '*********************' ? App::_encryptSecret($_POST['kr-adm-coinpaymentsmarchandid']) : $_POST['kr-adm-coinpaymentsmarchandid']),
      "coinpayment_ipn_secret" => ($_POST['kr-adm-coinpaymentsipnsecret'] != '*********************' ? App::_encryptSecret($_POST['kr-adm-coinpaymentsipnsecret']) : $_POST['kr-adm-coinpaymentsipnsecret']),
      ...
      "payeer_shopid" => ($_POST['kr-adm-payeershopid'] != '*********************' ? App::_encryptSecret($_POST['kr-adm-payeershopid']) : $_POST['kr-adm-payeershopid']),
      "payeer_apikey" => ($_POST['kr-adm-payeerapikey'] != '*********************' ? App::_encryptSecret($_POST['kr-adm-payeerapikey']) : $_POST['kr-adm-payeerapikey']),
      ...
      "polipayments_authcode" => ($_POST['kr-adm-polipaymentsauthcode'] != '*********************' ? App::_encryptSecret($_POST['kr-adm-polipaymentsauthcode']) : $_POST['kr-adm-polipaymentsauthcode']),
      "polipayments_marchandcode" => ($_POST['kr-adm-polipaymentsmarchandcode'] != '*********************' ? App::_encryptSecret($_POST['kr-adm-polipaymentsmarchandcode']) : $_POST['kr-adm-polipaymentsmarchandcode']),
      ...
      "paystack_publickey" => ($_POST['kr-adm-paystackpublickey'] != '*********************' ? App::_encryptSecret($_POST['kr-adm-paystackpublickey']) : $_POST['kr-adm-paystackpublickey']),
      "paystack_privatekey" => ($_POST['kr-adm-paystackprivatekey'] != '*********************' ? App::_encryptSecret($_POST['kr-adm-paystackprivatekey']) : $_POST['kr-adm-paystackprivatekey']),
