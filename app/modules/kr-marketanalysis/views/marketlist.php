...
<div class="kr-marketcoinlist">
  ...
  <nav class="kr-marketnav">
    ...
    <form class="kr-search-market" action="" method="post">
      <input type="text" name="kr-search-value" placeholder="Search exchange / pair / symbol ..." value="<?php echo (!isset($_POST['search']) || empty($_POST['search']) ? '' : htmlspecialchars($_POST['search'], ENT_QUOTES, 'UTF-8')); ?>">
    </form>
  </nav>
